...
public class SelectiveMicrobiosimaK extends Microbiosima {
    ...
    public static void main(String[] args) throws FileNotFoundException, UnsupportedEncodingException {
        ...
        System.out.println(sb.toString());
                ...
                for (int rep=0;rep<numberOfReplication;rep++){
                    ...
                    System.out.println("Output 13 result files in the format of: "+prefix+"[****]" +sufix);
                    try{
                        ...
                        MathUtil.setSeed();
                        SelectivePopulationK population=new SelectivePopulationK(microSize, environment, populationSize, pctEnv , pctPool,0,0,ssr,hsCoeff,HMS_or_TMS);
                        ...
                        for (SelectiveIndividualK host:population.getIndividuals()){
